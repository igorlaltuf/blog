...
library(lubridate)
```
O DAIL contém apenas duas funções: requests() e appeals(). A primeira faz o download dos pedidos, a segunda realiza dos dados provenientes dos recursos. Por meio do argumento "search" é possível buscar por uma palavra-chave específica.  
